...
<div class="container mx-auto py-8">
    <div class="flex space-x-10 mb-6 justify-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($courses as $course)
            <div class="bg-[#ddbcf3] dark:bg-gray-800 rounded-lg shadow p-6 flex flex-col justify-between h-full hover:shadow-xl transition-shadow duration-300">
            @if($course->thumbnail)
    ...
    @endif
        ...
        @empty
            <div class="col-span-3 text-center text-gray-500 dark:text-gray-400">Aucun cours trouvé.</div>
        @endforelse
    </div>
    <div class="mt-8">
